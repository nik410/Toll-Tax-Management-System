...
if (strlen($_SESSION['ttmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $catname=$_POST['catname'];
       ...
       $query=mysqli_query($con, "insert into  tblcategory(VehicleCat,Amount) value('$catname','$amount')");
    if ($query) {
    ...
    echo $msg;
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <label class="control-label">Vehicle Amount</label>
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  required="true" id="amount" name="amount" value="">
            </div>
